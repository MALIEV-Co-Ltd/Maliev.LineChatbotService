...
class SecretManager:
    ...
    async def get_secret(self, secret_name: str, use_cache: bool = True) -> str | None:
    ...
    async def _get_secret_from_source(self, secret_name: str) -> str | None:
    ...
    async def _get_cached_secret(self, secret_name: str) -> str | None:
    ...
    async def invalidate_cache(self, secret_name: str | None = None):
    ...
    async def create_secret(self, secret_id: str, secret_value: str, labels: dict[str, str] | None = None) -> bool:
