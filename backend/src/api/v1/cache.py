...
async def list_cache_entries(
    cache_type: str | None = Query(None, regex="^(exact|semantic|pattern)$"),
...
@router.delete("/clear")
async def clear_cache(cache_type: str | None = Query(None, regex="^(exact|semantic|pattern|all)$")) -> dict[str, Any]:
